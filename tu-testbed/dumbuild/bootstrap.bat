...
rem Make dmb.exe
cl -Fedmb.exe ../../compile_util.cpp ../../config.cpp ../../context.cpp ../../dumbuild.cpp ../../exe_target.cpp ../../lib_target.cpp ../../object.cpp ../../os.cpp ../../res.cpp ../../target.cpp ../../util.cpp -Zi -GX -I../../jsoncpp/include -link lib_json.lib -subsystem:console
