...
template<typename T> inline bool jit_is_8bit( const T value ) { return value < 128 && value >= -128; }
template<typename T> inline bool jit_is_8bit( const T* ) { return false; }
...
#define jit_pushargi( _function_, _arg_ ) jit_pushi( _function_, (uint32)_arg_ )
